...
# b) A real estate agent has 8 master keys to open several new homes. Only 1 master key
# will open any given house. If 40% of these homes are usually left unlocked, what is the
